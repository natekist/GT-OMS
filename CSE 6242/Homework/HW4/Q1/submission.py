...
def author():                                                                                             
        return " 903613888" # replace gburdell3 with your Georgia Tech username.
                                                                                              
def gtid():                                                                                               
    return 903613888 # replace with your GT ID number
...
class PageRank:
    ...
    def calculate_node_degree(self):
        ...
        #############################################
            ...
            if temp > self.max_node_id:
                self.max_node_id = temp
            else:
                pass
    ...
    def run_pagerank(self, node_weights,  damping_factor=0.85, iterations=10):
        ...
        #############################################
            ...
            for i in range(len(new_pr_values)):
